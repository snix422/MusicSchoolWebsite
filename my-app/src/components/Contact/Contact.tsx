    ...
    return(
        <div className="min-h-screen">
            ...
            <motion.div  className="w-screen min-h-screen bg-yellow-900 flex flex-col items-center gap-36 max-sm:justify-center max-sm:gap-28 xl:pt-36 lg:'pt-28 md:pt-28 sm:pt-28 max-sm:pt-16 pb-10">
                <motion.h2 initial={{y:-100,opacity:0}} animate={{y:0,opacity:1}} transition={{delay:0.5, duration:1}} className="text-white text-3xl" style={{fontFamily:'Montserrat'}}>Kontakt</motion.h2>
                <motion.div initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{delay:0.5, duration:1}} className="flex justify-center gap-36 max-lg:flex-col">
                    <div className="flex flex-col gap-5 rounded">
                        <h2 className="text-white text-2xl" style={{fontFamily:'Montserrat'}}>Główna Siedziba</h2>
