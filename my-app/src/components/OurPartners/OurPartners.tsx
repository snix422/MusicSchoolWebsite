    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="w-screen min-h-screen bg-black flex flex-col items-center gap-28 max-sm:justify-center max-sm:gap-10 xl:pt-36 lg:'pt-48 md:pt-28 sm:pt-28 pb-10 max-sm:pt-10">
                <motion.h2 initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{delay:0.5, duration:1}} className="text-white text-4xl" style={{fontFamily:'Montserrat'}}>Nasi partnerzy</motion.h2>
