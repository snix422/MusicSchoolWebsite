    ...
    <div className="min-h-screen">
      ...
      <div className="w-screen min-h-screen bg-black flex flex-col items-center gap-28 pt-10 pb-10 max-sm:justify-center max-sm:gap-10 xl:pt-28 lg:pt-28 md:pt-28 sm:pt-28">
        ...
        <motion.p
          ...
          style={{ fontFamily: "Montserrat" }}
        >
          Nazywam się Łukasz Różyło, jestem pianistą, organistą, kameralistą,
          nauczycielem oraz organizatorem i animatorem życia muzycznego. Grę na
          fortepianie rozpocząłem w wieku 6 lat w Sandomierzu. <br />
          <br />
          Ukończyłem z wyróżenieniem Salezjańską Ogólnokształcącą Szkołę
          Muzyczną w Lutomiersku, a następnie studia magisterskie w
          ...
          wyróżnieniem. Otrzymałem liczne nagrody podczas ogólnopolskich oraz
          międzynarodowych konkursów muzycznych: byłem półfinalistą
          Międzynarodowego Konkursu Organowego im. Dietricha Buxtehudego w
          Lubece (2022), 3 nagrodę na Ogólnopolskim Konkursie Kameralnym: Organy
          - partner w kameralistyce (2022), jak również wyróżnienie na
          Ogólnopolskim Konkursie Organowym im. Bronisława Rutkowskiego w
          Krakowie (2021). <br />
          <br />
          Wspólpracowałem m.in. z Chórem oraz Orkiestrą Symfoniczną Filharmonii
          Łódzkiej. Występowałem na ogólnopolskich oraz międzynarodowych
          ...
          i II stopnia w Kutnie, jako pianista oraz akompaniator. Pełnię także
          ...
          bezkompromisowy - uważam, że droższa lekcja pod okiem doświadczonego
          nauczyciela, szczególnie na początku, jest dużo bardziej wydajna, niż
          pozornie tańsza w wykonaniu praktykanta. Pasjonuje mnie tworzenie
