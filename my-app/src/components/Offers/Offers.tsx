...
const Offers = () => {
  ...
  return (
    <div className="min-h-screen">
      <NavBar />
      <div className="w-screen h-screen bg-yellow-900 flex flex-col items-center gap-28 max-sm:justify-center max-sm:gap-10 xl:pt-48 lg:pt-48 md:pt-28 sm:pt-28">
        <motion.h2
